...
export default function Panel() {
    ...
    return (
        <SideBar>
            ...
            <PanelLinks>
                <NavLink to='/dashboard' className={({ isActive }) => isActive ? 'LinkActive' : ''}><LuLayoutDashboard size={26} />Dashboard</NavLink>
                <NavLink to='/bookings' className={({ isActive }) => isActive ? 'LinkActive' : ''}><LuCalendarCheck2 size={26} />Bookings</NavLink>
                <NavLink to='/rooms' className={({ isActive }) => isActive ? 'LinkActive' : ''}><MdOutlineBedroomParent size={26} />Rooms</NavLink>
